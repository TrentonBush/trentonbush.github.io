...
2. Does this extra recoverable power predictably correlate with power prices? [Can we forecast the impact on future revenue?]
3. Can this excess power be adequately modeled with existing turbulence metrics based on standard deviation? [Do we need to bother implementing new stuff?]
